...
public class CustomerServiceMapImpl implements CustomerService {
	...
	public List<CustomerDTO> getAllCustomers() {
		...
		log.debug("Customer Map : getAllCustomers");
	...
	public CustomerDTO getCustomerById(Long id) {
		...
		log.debug("Customer Map : GetCustomerById " + id);
	...
	public CustomerDTO createCustomer(CustomerDTO customerDTO) {
		...
		log.debug("Customer Map : Create Customer");
	...
	public CustomerDTO updateCustomer(CustomerDTO customerDTO) {
		...
		log.debug("Customer Map : update customer");
	...
	public void deleteCustomer(Long id) {
		...
		log.debug("Customer Map : delete customer by id " + id);
