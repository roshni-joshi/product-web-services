...
public class ProductServiceMapImpl implements ProductService {
	...
	public List<ProductDTO> getAllProducts() {
		...
		log.debug("Product Map : Get All Products");
	...
	public ProductDTO getProductById(Long id) {
		log.debug("Product Map : Get Product By Id");
	...
	public ProductDTO createProduct(ProductDTO productDTO) {
		log.debug("Product Map : Create Product");
	...
	public ProductDTO updateProduct(ProductDTO productDTO) {
		log.debug("Product Map : Update Product");
	...
	public void deleteProduct(Long id) {
		...
		log.debug("Product Map : Delete Product By Id : " + id);
